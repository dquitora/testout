    ...
    function (a, b, c) {
        b.extend(c.shares, {
            ...
            email: {
                label: "E-mail",
                logo: "fa fa-at",
                shareUrl: "mailto:?subject={text}&body={text}",
                countUrl: ""
            },
            twitter: {
                label: "Tweet",
                logo: "fa fa-twitter",
                shareUrl: "https://twitter.com/share?text={text}&via={via}&hashtags={hashtags}",
                countUrl: ""
            },
            facebook: {
                label: "Like",
                logo: "fa fa-facebook",
                shareUrl: "https://facebook.com/sharer/sharer.php?u=www.petnet.co",
                countUrl: function () {
                    return "https://graph.facebook.com/fql?q=SELECT total_count FROM link_stat WHERE url='www.petnet.co'"
                },
                getCount: function (a) {
